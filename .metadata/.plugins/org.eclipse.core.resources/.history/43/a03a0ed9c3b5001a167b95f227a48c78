...
<link rel="stylesheet" href="http://15.164.225.143:8080/teuching/resources/css/landing/aboutUs.css"/>
</head>
<body onload="move_text('false')">
   ...
   <div class="aboutUsModalWrap">
      <div class="aboutUsModal">
         ...
         <video class="aboutUsVideo" controls autoplay width="1000" style="margin-left: 8px;">
            <source src="http://15.164.225.143:8080/teuching/resources/video/aboutUs.mp4" type="video/mp4">
         </video>
      </div>
   </div>
   ...
   <script src="http://15.164.225.143:8080/teuching/resources/js/landing/aboutUs.js"></script>
</body>
</html>