...
<link rel="stylesheet" href="http://15.164.225.143:8080/teuching/resources/css/manager/managerAnswer.css">
	...
	<div class="wrapper">
		<div class="ansbox-top">
			<div
				...
				style="float: left; background-image: url(http://15.164.225.143:8080/teuching/resources/upload/profileImg/${res.tr_email}.PNG); width: 15%; height: 75%;">
			...
			<form
				action="http://15.164.225.143:8080/teuching/manager/reportdetail/modify.do"
				method="post">
				<h5>${res.report_date }
