...
public class MemberServiceImpl implements MemberService {
	...
	// 일반회원 메일링 관련
	public void m_mailSending(Map<String, Object> commandMap) {

		String from = "teuching.official@gmail.com"; // 발신자메일 설정
		String tomail = (String) commandMap.get("email"); // 사용자의 이메일 //
		String title = "나를 위한 트레이너 매칭, TeuChing 가입을 환영합니다.";
	...
	// 트레이너 회원가입 메일링
	public void t_mailSending(Map<String, Object> commandMap) {

		String from = "teuching.official@gmail.com"; // 발신자메일 설정
		String tomail = (String) commandMap.get("email"); // 사용자의 이메일 //
		String title = "트레이너님! 나를 위한 트레이너 매칭, TeuChing과 함께해주셔서 감사합니다!.";
		String htmlBody = "<form action='http://" + commandMap.get("urlPath")
