													...
													<div class="tab-pane active" id="home">
														...
														<form class="form" method="post" id="trainerUpdate"
															...
															<div class="form-group">
																...
																<div class="col-xs-6">
																	...
																	<div class="form-control" id="email">
																		...
																		<input type="hidden" name="email"
																			value="${loginInfo.tr_email}" /> >>>>>>>
																		96ded92407b2c2950470ad8f335c4058baece4d8
																	</div>
																</div>
																<div class="form-group">
																...
																<div class="form-group">
																	<div class="col-xs-6">
																		<label><h4>Phone</h4></label> <span
																			style="font-size: small;">붙임표(-)까지 입력해주세요.</span></label> <input
																...
																<div class="form-group">
																	...
																	<div class="col-xs-6">
																		...
																		<input type="password" class="form-control"
																			id="password_1" name="password" class="pw"
																			maxlength="20">
																...
																<div class="form-group">
																	<div class="col-md-12">
																		<div class="form-group focused">
																			<label><h4>
																					GYM Address
																					<h4></h4></label><br> <input type="text"
																				id="sample6_postcode" placeholder="우편번호"> <input
																				type="button" onclick="sample6_execDaumPostcode()"
																				value="우편번호 찾기"><br> <label></label><br>
																			<input type="text" id="sample6_address"
																				placeholder="현재 주소 : ${loginInfo.address}"
																				name="address" style="width: 55%; height: 30px;">
																			...
																			<br> <input type="text"
																				...
																				class="form-control-label" for="input-address"></label>
																	...
																	<div class="col-xs-6">
																		<div class="form-group focused">
																			<label class="form-control-label" for="input-address">선호
																				지역 선택하기</label> <br> 지역 1 <select name="prefer1-1"
																				id="sido1"></select> <select name="prefer1-2"
																				id="gugun1"></select> <br> 지역 2 <select
																				name="prefer2-1" id="sido2"></select> <select
																				name="prefer2-2" id="gugun2"></select> <br> 지역
																			3 <select name="prefer3-1" id="sido3"></select> <select
																...
																<div class="form-group">
																	...
																	<div class="col-xs-12">
																		...
																		<br /> <span style="color: #aaa;" id="counter">(0
																			/ 최대 500자)</span>
																	</div>
																</div>
