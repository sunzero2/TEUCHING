				...
				<c:forEach items="${res.resTra.selectTraReport }" var="r">
					<div class="panel panel-info" style="margin: 1em;">
						<div class="panel-heading">
							...
							<a
								href="http://15.164.225.143:8080/teuching/manager/reportdetail.do?traid=${r.report_idx}">
							...
							<ul>
								...
								<c:forEach begin="${res.resTra.pagingTra.blockStart }"
									...
									<li class="active"><span> <a
											href="http://15.164.225.143:8080/teuching/manager/report.do?tracurrentpage=${pt}">${pt }</a>
									</span></li>
								</c:forEach>
								<c:if
